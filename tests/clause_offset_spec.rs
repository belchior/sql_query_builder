...
mod select_command {
  ...
  fn method_raw_before_should_add_raw_sql_before_offset_clause() {
    let query = sql::Select::new()
      .raw_before(sql::SelectClause::Offset, "limit 1000")
      .offset("50")
      .as_string();
...
mod delete_command {
  ...
  #[test]
  fn method_offset_should_add_the_offset_clause() {
    let query = sql::Delete::new().offset("100").as_string();
    let expected_query = "OFFSET 100";
  ...
  #[test]
  fn method_offset_should_override_the_current_value() {
    let query = sql::Delete::new().offset("100").offset("200").as_string();
    let expected_query = "OFFSET 200";
  ...
  #[test]
  fn method_offset_should_trim_space_of_the_argument() {
    let query = sql::Delete::new().offset("  2000  ").as_string();
    let expected_query = "OFFSET 2000";
  ...
  #[test]
  fn clause_offset_should_be_after_limit_clause() {
    let query = sql::Delete::new().limit("500").offset("100").as_string();
    let expected_query = "LIMIT 500 OFFSET 100";
  ...
  fn method_raw_before_should_add_raw_sql_before_offset_clause() {
    let query = sql::Delete::new()
      .raw_before(sql::DeleteClause::Offset, "limit 1000")
      .offset("50")
      .as_string();
    let expected_query = "limit 1000 OFFSET 50";
  ...
  fn method_raw_after_should_add_raw_sql_after_offset_clause() {
    let query = sql::Delete::new()
      .offset("10")
      .raw_after(sql::DeleteClause::Offset, "/* the end */")
      .as_string();
    let expected_query = "OFFSET 10 /* the end */";
...
mod update_command {
  ...
  #[test]
  fn method_offset_should_add_the_offset_clause() {
    let query = sql::Update::new().offset("100").as_string();
    let expected_query = "OFFSET 100";
  ...
  #[test]
  fn method_offset_should_override_the_current_value() {
    let query = sql::Update::new().offset("100").offset("200").as_string();
    let expected_query = "OFFSET 200";
  ...
  #[test]
  fn method_offset_should_trim_space_of_the_argument() {
    let query = sql::Update::new().offset("  2000  ").as_string();
    let expected_query = "OFFSET 2000";
  ...
  #[test]
  fn clause_offset_should_be_after_limit_clause() {
    let query = sql::Update::new().limit("500").offset("100").as_string();
    let expected_query = "LIMIT 500 OFFSET 100";
  ...
  fn method_raw_before_should_add_raw_sql_before_offset_clause() {
    let query = sql::Update::new()
      .raw_before(sql::UpdateClause::Offset, "limit 1000")
      .offset("50")
      .as_string();
    let expected_query = "limit 1000 OFFSET 50";
  ...
  fn method_raw_after_should_add_raw_sql_after_offset_clause() {
    let query = sql::Update::new()
      .offset("10")
      .raw_after(sql::UpdateClause::Offset, "/* the end */")
      .as_string();
    let expected_query = "OFFSET 10 /* the end */";
